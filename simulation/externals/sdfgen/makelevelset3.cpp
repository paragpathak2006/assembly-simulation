                  ...
                  int di, int dj, int dk)
{
   ...
   for(int k=k0; k!=k1; k+=dk) for(int j=j0; j!=j1; j+=dj) for(int i=i0; i!=i1; i+=di){
      //std::cerr << "i, j, k:   " << i << ", " << j << ", " << k << std::endl << std::endl;
      if (k!=k_past) {
                     ...
                     Array3f &phi, const int exact_band)
{
   ...
   for(unsigned int pass=0; pass<2; ++pass){
      ...
      //std::cerr << "Checkpoint MLS 1" << std::endl;
      sweep(tri, x, phi, closest_tri, origin, dx, dy, dz, -1, -1, -1);
      //std::cerr << "Checkpoint MLS 2" << std::endl;
      sweep(tri, x, phi, closest_tri, origin, dx, dy, dz, +1, +1, -1);
      //std::cerr << "Checkpoint MLS 3" << std::endl;
      sweep(tri, x, phi, closest_tri, origin, dx, dy, dz, -1, -1, +1);
      //std::cerr << "Checkpoint MLS 4" << std::endl;
      sweep(tri, x, phi, closest_tri, origin, dx, dy, dz, +1, -1, +1);
      //std::cerr << "Checkpoint MLS 5" << std::endl;
      sweep(tri, x, phi, closest_tri, origin, dx, dy, dz, -1, +1, -1);
      //std::cerr << "Checkpoint MLS 6" << std::endl;
      sweep(tri, x, phi, closest_tri, origin, dx, dy, dz, +1, -1, -1);
      //std::cerr << "Checkpoint MLS 7" << std::endl;
      sweep(tri, x, phi, closest_tri, origin, dx, dy, dz, -1, +1, +1);
      //std::cerr << "Checkpoint MLS 8" << std::endl;
   }
